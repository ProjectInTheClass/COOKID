...
class DummyData {
    ...
    lazy var posts = [
        Post(user: singleUser, images: [URL(string: "https://images.unsplash.com/photo-1618107057892-67f36135fe17?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80")!, URL(string: "https://cdn-square.bizhost.kr/files/promo_img/210909_adidaspng.png")!], caption: "제주도 맛집! 완전 추천! 여기 진짜 맛있었어요. 가격도 적당하고 대충 3-4만원 정도 예상하고 가시면 되는데, 진짜 완전완전 강추입니다:) 꼭 가보세요!", mealBudget: 30, location: "경기"),
        Post(user: singleUser, images: [URL(string: "https://images.unsplash.com/photo-1618107057892-67f36135fe17?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80")!], caption: "조금 비싼 라면.. 하지만 맛있어요", mealBudget: 12000, location: "제주도"),
        ...
        Post(user: singleUser, images: [URL(string: "https://images.unsplash.com/photo-1618107057892-67f36135fe17?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80")!], caption: "oh! no!", mealBudget: 80000, location: "경북"),
        Post(user: singleUser, images: [URL(string: "https://images.unsplash.com/photo-1618107057892-67f36135fe17?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1234&q=80")!, URL(string: "https://cdn-square.bizhost.kr/files/promo_img/210909_adidaspng.png")!], caption: "oh! no!", mealBudget: 5000000, location: "문경")
    ]
}
