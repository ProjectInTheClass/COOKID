...
class DummyData {
    ...
    var myMeals = [
        ...
        Meal(price: 8000, date: Date(), name: "순대국밥", image: URL(string: "photo.on.rectangle.angled")!, mealType: .dineOut, mealTime: .lunch),
        Meal(price: 30000, date: Date(), name: "광어회", image: URL(string: "photo.on.rectangle.angled")!, mealType: .dineOut, mealTime: .lundinner),
        Meal(price: 1200, date: Date(), name: "젤리", image: URL(string: "photo.on.rectangle.angled")!, mealType: .dineIn, mealTime: .breakfast),
        Meal(price: 25000, date: Date(), name: "아귀찜", image: URL(string: "photo.on.rectangle.angled")!, mealType: .dineIn, mealTime: .dinner)]
