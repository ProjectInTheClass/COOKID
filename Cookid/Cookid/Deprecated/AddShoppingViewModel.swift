...
//        let newShopping: Observable<Shopping>
//    }
//
//    var input: Input
//    var output: Output
...
//
//        let newShopping = Observable.combineLatest(shoppingDate, shoppingPrice) { date, price -> Shopping in
//
//            let validMealPrice = Int(price) ?? 0
//
//            return Shopping(id: shoppingID ?? "", date: date, totalPrice: validMealPrice)
//        }
//
